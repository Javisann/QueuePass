<template>
    ...
    <form class="max-w-xs mx-auto">
      ...
      <div class="relative flex items-center max-w-[8rem]">
        ...
        <button type="button" id="increment-button" @click="people <= 10 ? people++ : null" :disabled="people === 10" data-input-counter-increment="quantity-input"
      ...
      <p id="helper-text-explanation">Selecciona numero de personas</p>
    </form>
  ...
  let people = ref(0); // varaible reactiva de las personas seleccionadas
